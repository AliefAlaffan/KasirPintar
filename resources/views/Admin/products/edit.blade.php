            ...
            <div class="bg-white rounded-xl shadow p-6">
                <form action="{{ route('admin.products.update', $product->id) }}" method="POST" enctype="multipart/form-data" class="space-y-4">
                    ...
                    <div>
                        ...
                        @if ($product->image)
                            <div class="mt-2 mb-2">
                                ...
                                <p class="text-xs text-gray-400 mt-1">Gambar saat ini. Upload gambar baru untuk mengganti.</p>
                            </div>
                        @endif
                    ...
                    <div class="flex justify-end gap-2 pt-4">
                        ...
                        <button type="submit" class="px-4 py-2 bg-blue-600 text-white rounded-lg text-sm">Simpan Perubahan</button>
                    </div>
                </form>
            </div>
        </div>
